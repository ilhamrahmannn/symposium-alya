...
test("registration capacity limits match the approved participant allocation",()=>{assert.equal(ATTENDANCE.day1.capacity,150);assert.equal(ATTENDANCE.full.capacity,15)});
