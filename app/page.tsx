...
const dayOneProgramme=[
  ...
  ["8:30am - 9:30am","Keynote Speaker: Current Perspectives in the Multidisciplinary Management of Pierre Robin Sequence","Prof. Dr. Firdaus Bin Hariri"],
  ["9:30am - 9:45am","Opening Ceremony","Officiated by Dr. Juanna Binti Bahadun, Head of Johor State Paediatric Dentistry Services"],
  ["9:45am - 10:45am","Lecture 1: Early Recognition and Neonatal Management of Pierre Robin Sequence","Dr. Chia Lee Ser"],
  ["10:45am - 11:00am","Morning Break"],
  ["11:00am - 12:00pm","Lecture 2: Airway Assessment and Respiratory Management in Infants with Pierre Robin Sequence","Dr. Liew Zheyi"],
  ["12:00pm - 1:00pm","Lecture 3: Airway Evaluation and Intervention in Pierre Robin Sequence","Dr. Selvamalar Vengathajalam"],
  ["1:00pm - 2:00pm","Lunch, Prayer & Break"],
  ["2:00pm - 3:00pm","Lecture 4: Non-Surgical Management of Infants with Pierre Robin Sequence","Dr. Halimah Bt Mohamed Noor"],
  ["3:00pm - 4:00pm","Lecture 5: Surgical Considerations in Pierre Robin Sequence","Dr. Sundrarajan Naidu Ramasamy"],
  ["4:00pm - 4:30pm","Q & A"],
...
export default function EventHomepage(){
  ...
  <section className="public-section attendance" id="attendance"><div className="section-heading"><span className="gold-kicker">ATTENDANCE OPTIONS</span><h2>Choose your learning experience</h2></div><div className="price-grid"><article><span>DAY 1 ONLY</span><h3>Symposium</h3><strong>RM150</strong><small>Overall Day 1 attendance is limited to 150 participants</small><Link className="outline-button" href="/register?attendance=day1">Select and Register</Link></article><article className="recommended"><i>FULL PROGRAMME</i><span>DAY 1 &amp; DAY 2</span><h3>Symposium and Workshop on Fabrication of OAP</h3><strong>RM300</strong><small>15 workshop places within the overall Day 1 capacity</small><Link className="gold-button" href="/register?attendance=full">Select and Register</Link></article></div></section>
