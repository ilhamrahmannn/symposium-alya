...
export const demoTransactions: Transaction[] = [
  {id:"t1",type:"income",amountInSen:500000,category:"Sponsorship",description:"Main clinical partner sponsorship",partyName:"MediCare Foundation",paymentMethod:"Bank Transfer",referenceNumber:"INC-001",transactionDate:"2026-07-03",status:"paid",createdBy:"Dr Ilham"},
  {id:"t2",type:"income",amountInSen:250000,category:"Participant Fees",description:"Early-bird delegate registrations",partyName:"Delegates",paymentMethod:"E-wallet",referenceNumber:"INC-002",transactionDate:"2026-07-05",status:"paid",createdBy:"Dr Ilham"},
  {id:"t3",type:"income",amountInSen:100000,category:"Donations",description:"Clinical education donation",partyName:"Anonymous Donor",paymentMethod:"Bank Transfer",referenceNumber:"INC-003",transactionDate:"2026-07-07",status:"approved",createdBy:"Dr Ilham"},
  {id:"t4",type:"expense",amountInSen:150000,category:"Venue",description:"Symposium hall deposit",partyName:"Orchid Convention Centre",paymentMethod:"Bank Transfer",referenceNumber:"EXP-001",transactionDate:"2026-07-08",status:"paid",createdBy:"Dr Ilham",receiptName:"venue-deposit.pdf"},
  {id:"t5",type:"expense",amountInSen:120000,category:"Food and Beverages",description:"Delegate catering deposit",partyName:"Savour Events",paymentMethod:"Credit Card",referenceNumber:"EXP-002",transactionDate:"2026-07-10",status:"paid",createdBy:"Dr Ilham",receiptName:"catering.jpg"},
  {id:"t6",type:"expense",amountInSen:80000,category:"Equipment",description:"Airway simulation equipment",partyName:"Clinical Sim Supplies",paymentMethod:"Bank Transfer",referenceNumber:"EXP-003",transactionDate:"2026-07-11",status:"approved",createdBy:"Dr Ilham"},
  {id:"t7",type:"expense",amountInSen:35000,category:"Marketing",description:"Digital programme promotion",partyName:"Studio Rose",paymentMethod:"Debit Card",referenceNumber:"EXP-004",transactionDate:"2026-07-13",status:"paid",createdBy:"Dr Ilham"},
  {id:"t8",type:"expense",amountInSen:20000,category:"Printing",description:"Delegate handbook printing",partyName:"PrintHub KL",paymentMethod:"Cheque",referenceNumber:"EXP-005",transactionDate:"2026-07-15",status:"pending",createdBy:"Dr Ilham"},
  {id:"t9",type:"expense",amountInSen:45000,category:"Transportation",description:"Faculty airport transfers",partyName:"KL Executive Transport",paymentMethod:"Bank Transfer",referenceNumber:"EXP-006",transactionDate:"2026-07-16",status:"approved",createdBy:"Dr Ilham"},
];
